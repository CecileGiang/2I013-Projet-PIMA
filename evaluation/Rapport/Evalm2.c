...
int main(){
    ...
    unsigned long int deg,y;
    clock_t t1, t2; // les deux variable pour stocker le temps .
    float temps,temps2,temps3;
    printf("saisir y pour avoir les coefficients au plus 2^y /\ny=");
    scanf("%lu", &y);

    printf("saisir le degre /\nn=");
    ...
    effacer_fichier("E2_f1_num.txt");
    effacer_fichier("E2_f1_denom.txt");
    effacer_fichier("E2_temps.txt");
    effacer_fichier("E2_f2_num.txt");
    effacer_fichier("E2_f2_denom.txt");
    effacer_fichier("E2_Horner_num.txt");
    effacer_fichier("E2_Horner_denom.txt");
    ...
    for(i=1; i<=y; i++){
        ...
        set_coefficients("coefficients_p",deg,i); //Ecriture de coefficients de type mpz_t aléatoires dans le fichier avec degre deg
        ...
        eval_poly_1(tab, a, k, deg, &res_num1, &res_denom1);
        ...
        t1=clock();
        eval_poly_2(tab, a, k, deg, &res_num2, &res_denom2);
        //gmp_printf("\n\nResultat méthode 2: num = %Zd\t \n den = %Zd\n", res_num2, res_denom2);
        t2=clock();

        temps2=(float)(t2-t1)/CLOCKS_PER_SEC;
        t1=clock();
        evaluateHorner(tab, a, k, deg, &res_num3, &res_denom3);
        ...
        ecrit_result("E2_f1_num.txt", res_num1);//FICHIER qui contient les numerateurs pour M1
        ecrit_result("E2_f1_denom.txt", res_denom1);//FICHIER qui contient les dénominateurs M1

        ecrit_result("E2_f2_num.txt", res_num2);
        ecrit_result("E2_f2_denom.txt", res_denom2);

        ecrit_result("E2_Horner_num.txt", res_num3);
        ecrit_result("E2_Horner_denom.txt", res_denom3);

        //on multiplie le temps par 10000 pour insertion dans excel
        enregistrement_3("E2_temps.txt",(unsigned int)i,temps*10000,temps2*10000,temps3 *10000);
