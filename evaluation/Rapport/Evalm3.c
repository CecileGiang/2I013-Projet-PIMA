...
int main(){
    ...
    long long a,l,x=0, k;
    printf("Calcul de q(a/(2^k)), veuillez rentrer le max de\na:\n");
    scanf("%llu", &l);
    ...
    effacer_fichier("E3_f1_num.txt");
    effacer_fichier("E3_f1_denom.txt");
    effacer_fichier("E3_temps.txt");
    effacer_fichier("E3_f2_num.txt");
    effacer_fichier("E3_f2_denom.txt");
    effacer_fichier("E3_Horner_num.txt");
    effacer_fichier("E3_Horner_denom.txt");
    ...
    for(i=1; i<=l; i++){
        ...
        ecrit_result("E3_f1_num.txt", res_num1);//FICHIER qui contient les numerateurs pour M1
        ecrit_result("E3_f1_denom.txt", res_denom1);//FICHIER qui contient les dénominateurs M1

        ecrit_result("E3_f2_num.txt", res_num2);
        ecrit_result("E3_f2_denom.txt", res_denom2);

        ecrit_result("E3_Horner_num.txt", res_num3);
        ecrit_result("E3_Horner_denom.txt", res_denom3);

        //on multiplie le temps par 10000 pour insertion dans excel
        enregistrement_3("E3_temps.txt",(unsigned int)i,temps*10000,temps2*10000,temps3 *10000);
