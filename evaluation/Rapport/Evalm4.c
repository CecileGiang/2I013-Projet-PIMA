...
int main(){
    ...
    effacer_fichier("E4_f1_num.txt");
    effacer_fichier("E4_f1_denom.txt");
    effacer_fichier("E4_temps.txt");
    effacer_fichier("E4_f2_num.txt");
    effacer_fichier("E4_f2_denom.txt");
    effacer_fichier("E4_Horner_num.txt");
    effacer_fichier("E4_Horner_denom.txt");
    ...
    for(i=1; i<=l; i++){
        ...
        ecrit_result("E4_f1_num.txt", res_num1);//FICHIER qui contient les numerateurs pour M1
        ecrit_result("E4_f1_denom.txt", res_denom1);//FICHIER qui contient les dénominateurs M1

        ecrit_result("E4_f2_num.txt", res_num2);
        ecrit_result("E4_f2_denom.txt", res_denom2);

        ecrit_result("E4_Horner_num.txt", res_num3);
        ecrit_result("E4_Horner_denom.txt", res_denom3);

        //on multiplie le temps par 10000 pour insertion dans excel
        enregistrement_3("E4_temps.txt",(unsigned int)i,temps*10000,temps2*10000,temps3 *10000);
